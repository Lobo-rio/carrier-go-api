...
func Test_HandlerError_Internal_Server_Error(t *testing.T) {
	assert := assert.New(t)
...
func Test_HandlerError_Domain_Error(t *testing.T) {
	assert := assert.New(t)
...
func Test_HandlerError_Domain_Obj_Status(t *testing.T) {
	assert := assert.New(t)
